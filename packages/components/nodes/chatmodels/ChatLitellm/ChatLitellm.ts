    ...
    constructor() {
        ...
        this.inputs = [
            ...
            },
            {
                ...
                type: 'boolean',
                description:
                    'Allow image input. Image uploads need a model marked supports_vision=true in LiteLLM. Refer to the <a href="https://docs.vox-scribe.com/using-flowise/uploads#image" target="_blank">docs</a> for more details.',
                default: false,
                optional: true
            },
            {
