...
const GitHubStarButton = ({ starCount, isDark }) => {
    ...
    return (
        <Link href='https://github.com/acharlesgithub/Flowise' target='_blank' underline='none' sx={{ display: 'inline-flex' }}>
            <Box
                sx={{
                    display: 'flex',
                    alignItems: 'center',
...
const Header = ({ handleLeftDrawerToggle }) => {
    ...
    const { isEnterpriseLicensed, isCloud, isOpenSource, hasBilling } = useConfig()
    ...
    // GitHub star count fetch removed (rebranded)
