...
const swaggerUiOptions = {
    ...
    definition: {
        openapi: '3.0.3',
        info: {
            title: 'VoxScribe APIs',
            summary: 'Interactive swagger-ui auto-generated API docs from express, based on a swagger.yml file',
            version: '1.0.0',
            description:
                'This module serves auto-generated swagger-ui generated API docs from VoxScribe express backend, based on a swagger.yml file. Swagger is available on: http://localhost:6655/api-docs',
            license: {
                name: 'Apache 2.0',
                url: 'https://github.com/acharlesgithub/Flowise/blob/main/LICENSE.md'
            },
            contact: {
                name: 'VoxScribe',
                email: 'support@vox-scribe.com'
            }
        },
        servers: [
            {
                url: 'http://localhost:3000/api/v1',
                description: 'VoxScribe Server'
            }
        ]
    },
